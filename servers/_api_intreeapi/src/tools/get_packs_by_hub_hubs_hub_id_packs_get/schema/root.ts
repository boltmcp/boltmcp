...
export const inputParamsSchema = {
  ...
  "search": z.union([z.string().min(1), z.null()]).describe("Search for the title of the Pack.").optional(),
  ...
  "embed_revenue": z.boolean().describe("Get revenue and members in period for packs").optional(),
