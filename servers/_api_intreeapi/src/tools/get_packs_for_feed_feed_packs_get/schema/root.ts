...
export const inputParamsSchema = {
  ...
  "embed_subscription_data": z.boolean().describe("Embed subscription data if pack requires subscriptions. Otherwise, for free or one-time packs, it will be null.").optional(),
