...
export const inputParamsSchema = {
  ...
  "address": z.record(z.any()).describe("<llm-instruction>This part of the input schema is truncated. If you want to pass the property `address` to the tool, first call the tool `expandSchema` with \"/properties/customer/properties/address\" in the list of pointers. This will return the expanded input schema which you can then use in the tool call. You may have to call `expandSchema` multiple times if the schema is nested.</llm-instruction>\n<property-description>DTO for a Stripe Address.\n\nAn address is required to compute automatic tax for Stripe.\nThe amount of required fields depends on the country.</property-description>")
}