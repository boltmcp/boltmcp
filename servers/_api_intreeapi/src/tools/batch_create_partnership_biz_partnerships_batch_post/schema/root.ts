...
export const inputParamsSchema = {
  "business_id": z.string().uuid().describe("ID of current business making the call. The current biz user must be collaborator, admin or owner of this business."),
  "partner_ids": z.array(z.string().uuid()).max(20).describe("IDs of the businesses to create partnerships with. The current biz user must be collaborator, admin or owner of these businesses."),
