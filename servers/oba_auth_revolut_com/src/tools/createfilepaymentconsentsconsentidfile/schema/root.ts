...
export const inputParamsSchema = {
  ...
  "x-idempotency-key": z.string().regex(new RegExp("^(?!\\s)(.*)(\\S)$")).max(40).describe("Each request is processed only once per `x-idempotency-key`.\nThe idempotency key is valid for 24 hours."),
  "x-jws-signature": z.string().describe("A [detached JWS signature](https://developer.revolut.com/docs/guides/build-banking-apps/tutorials/work-with-json-web-signatures) of the body of the payload."),
