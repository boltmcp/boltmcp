...
const tool: OpenMCPServerTool = {
  "toolName": "getinternationalscheduledpaymentconsentsconsentidfundsconfirmati",
  "toolDescription": "Get funds confirmation for an international scheduled payment",
