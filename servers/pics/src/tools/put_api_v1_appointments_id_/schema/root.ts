...
export const inputParamsSchema = {
  ...
  "b_id": z.number().int().describe("The Appointment's ID"),
  ...
  "status": z.string().nullable().describe("The Appointment's Status").optional(),
  "subStatus": z.string().nullable().describe("The Appointment's Sub Status").optional(),
