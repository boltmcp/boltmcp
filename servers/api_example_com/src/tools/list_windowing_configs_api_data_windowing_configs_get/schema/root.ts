...
export const inputParamsSchema = {
  ...
  "enabled_only": z.boolean().describe("Apenas configurações habilitadas").optional(),
  "search": z.union([z.string(), z.null()]).describe("Buscar por nome ou descrição").optional()
}