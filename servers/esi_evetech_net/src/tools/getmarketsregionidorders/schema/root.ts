...
export const inputParamsSchema = {
  "region_id": z.number().int().describe("Return orders in this region"),
  "order_type": z.enum(["buy","sell","all"]).describe("Filter buy/sell orders, return all orders by default. If you query without type_id, we always return both buy and sell orders"),
  "page": z.number().int().gte(1).describe("Which page of results to return.").optional(),
  "type_id": z.number().int().describe("Return orders only for this type").optional(),
