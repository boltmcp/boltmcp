...
export const inputParamsSchema = {
  "corporation_id": z.number().int().describe("The ID of the corporation"),
  "include_completed": z.boolean().describe("Whether to retrieve completed corporation industry jobs. Only includes jobs from the past 90 days").optional(),
