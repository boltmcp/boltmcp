...
export const inputParamsSchema = {
  ...
  "division": z.number().int().describe("Wallet key of the division to fetch journals from"),
  "from_id": z.number().int().describe("Only show journal entries happened before the transaction referenced by this id").optional(),
