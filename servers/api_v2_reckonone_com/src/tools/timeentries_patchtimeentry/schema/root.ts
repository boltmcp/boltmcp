...
export const inputParamsSchema = {
  ...
  "employee": z.string().nullable().describe("The id or name of the employee that spent the time.").optional(),
  "timeEntryDate": z.string().datetime({ offset: true }).describe("Date of the time entry.").optional(),
  ...
  "approvalStatus": z.enum(["Draft","Submitted","Approved","Declined"]).describe("Time entry approval status.").describe("The time entry's approval status.").optional(),
