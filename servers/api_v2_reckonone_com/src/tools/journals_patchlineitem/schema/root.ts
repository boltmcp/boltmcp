...
export const inputParamsSchema = {
  ...
  "reconciliationStatus": z.enum(["Uncleared","Cleared","Reconciled"]).describe("Reconciliation status.").nullable().describe("The reconciliation status.").optional(),
  ...
  "ledgerAccount": z.string().nullable().describe("The id or full name of the ledger account.\nNote that the full name includes the name(s) of any parent ledger account(s) separated by colons.").optional(),
