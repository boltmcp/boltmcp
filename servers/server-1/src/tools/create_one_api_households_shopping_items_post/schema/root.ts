...
export const inputParamsSchema = {
  ...
  "recipeReferences": z.array(z.object({ "recipeId": z.string(), "recipeQuantity": z.number(), "recipeScale": z.union([z.number(), z.null()]), "recipeNote": z.union([z.string(), z.null()]).optional() })).optional(),
