...
const tool: OpenMCPServerTool = {
  "toolName": "delete_draft_item",
  "toolDescription": "Delete draft item",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/pc2_migration_items/{pc2-migration-item-id}/delete",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
  ...
  "paramsMap": {
    "path": {
      "pc2-migration-item-id": "pc2-migration-item-id"
    },
    "header": {
