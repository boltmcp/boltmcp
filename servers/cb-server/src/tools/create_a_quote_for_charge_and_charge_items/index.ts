...
const tool: OpenMCPServerTool = {
  "toolName": "create_a_quote_for_charge_and_charge_items",
  "toolDescription": "Create a quote for charges and charge items",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/quotes/create_for_charge_items_and_charges",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
