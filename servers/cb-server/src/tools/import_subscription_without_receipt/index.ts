...
const tool: OpenMCPServerTool = {
  "toolName": "import_subscription_without_receipt",
  "toolDescription": "Import Subscription Without Receipt",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/in_app_subscriptions/{in-app-subscription-app-id}/import_subscription",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
  ...
  "paramsMap": {
    "path": {
      "in-app-subscription-app-id": "in-app-subscription-app-id"
    },
    "header": {
