...
const tool: OpenMCPServerTool = {
  "toolName": "delete_draft_family",
  "toolDescription": "Delete draft family",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/pc2_migration_item_families/{pc2-migration-item-family-id}/delete",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
  ...
  "paramsMap": {
    "path": {
      "pc2-migration-item-family-id": "pc2-migration-item-family-id"
    },
    "header": {
