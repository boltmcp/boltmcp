...
const tool: OpenMCPServerTool = {
  "toolName": "create_invoice_for_items_and_one_time_charges",
  "toolDescription": "Create invoice for items and one-time charges",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/invoices/create_for_charge_items_and_charges",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
