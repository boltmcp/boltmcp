...
const tool: OpenMCPServerTool = {
  "toolName": "verify_bank_account_payment_source",
  "toolDescription": "Verify bank account payment source",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/payment_sources/{cust-payment-source-id}/verify_bank_account",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
