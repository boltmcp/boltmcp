...
const tool: OpenMCPServerTool = {
  "toolName": "retrieve_an_omnichannel_subscription",
  "toolDescription": "Retrieve an Omnichannel subscription",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/omnichannel_subscriptions/{omnichannel-subscription-id}",
  "method": "get",
  "security": [
    {
      "key": "Authorization",
