...
const tool: OpenMCPServerTool = {
  "toolName": "cancel_subscription_for_items_estimate",
  "toolDescription": "Cancel subscription for items estimate",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/subscriptions/{subscription-id}/cancel_subscription_for_items_estimate",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
