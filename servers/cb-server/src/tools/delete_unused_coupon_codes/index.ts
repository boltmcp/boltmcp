...
const tool: OpenMCPServerTool = {
  "toolName": "delete_unused_coupon_codes",
  "toolDescription": "Delete unused coupon codes",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/coupon_sets/{coupon-set-id}/delete_unused_coupon_codes",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
