...
const tool: OpenMCPServerTool = {
  "toolName": "edit_quote_for_charge_items_and_charges",
  "toolDescription": "Edit a quote for charges and charge items",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/quotes/{quote-id}/edit_for_charge_items_and_charges",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
