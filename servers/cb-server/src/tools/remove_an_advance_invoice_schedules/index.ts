...
const tool: OpenMCPServerTool = {
  "toolName": "remove_an_advance_invoice_schedules",
  "toolDescription": "Remove an advance invoice schedules",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/subscriptions/{subscription-id}/remove_advance_invoice_schedule",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
