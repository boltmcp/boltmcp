...
const tool: OpenMCPServerTool = {
  "toolName": "local_delete_a_virtual_bank_account",
  "toolDescription": "Local delete a virtual bank account",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/virtual_bank_accounts/{virtual-bank-account-id}/delete_local",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
  ...
  "paramsMap": {
    "path": {
      "virtual-bank-account-id": "virtual-bank-account-id"
    },
    "header": {
