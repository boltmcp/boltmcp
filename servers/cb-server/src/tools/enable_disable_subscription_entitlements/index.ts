...
const tool: OpenMCPServerTool = {
  "toolName": "enable_disable_subscription_entitlements",
  "toolDescription": "Enable/disable subscription entitlements",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/subscriptions/{subscription-id}/subscription_entitlements/set_availability",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
