...
const tool: OpenMCPServerTool = {
  "toolName": "create_a_quote_for_a_new_subscription_items",
  "toolDescription": "Create a quote for subscription creation",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/customers/{customer-id}/create_subscription_quote_for_items",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
