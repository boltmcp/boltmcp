...
const tool: OpenMCPServerTool = {
  "toolName": "remove_tax_withheld_refunds_from_a_credit_note",
  "toolDescription": "Remove tax withheld refunds from a credit note",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/credit_notes/{credit-note-id}/remove_tax_withheld_refund",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
