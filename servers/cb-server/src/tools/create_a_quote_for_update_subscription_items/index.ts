...
const tool: OpenMCPServerTool = {
  "toolName": "create_a_quote_for_update_subscription_items",
  "toolDescription": "Create a quote for subscription update",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/quotes/update_subscription_quote_for_items",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
