...
const tool: OpenMCPServerTool = {
  "toolName": "create_pricing_page_for_existing_subscription",
  "toolDescription": "Create pricing page for existing subscription",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/pricing_page_sessions/create_for_existing_subscription",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
