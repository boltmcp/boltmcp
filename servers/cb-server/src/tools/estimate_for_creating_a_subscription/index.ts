...
const tool: OpenMCPServerTool = {
  "toolName": "estimate_for_creating_a_subscription",
  "toolDescription": "Estimate for creating a subscription",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/customers/{customer-id}/create_subscription_for_items_estimate",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
