...
const tool: OpenMCPServerTool = {
  "toolName": "create_a_virtual_bank_account_using_permanent_token",
  "toolDescription": "Create a virtual bank account using permanent token",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/virtual_bank_accounts/create_using_permanent_token",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
