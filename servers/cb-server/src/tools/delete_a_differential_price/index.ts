...
const tool: OpenMCPServerTool = {
  "toolName": "delete_a_differential_price",
  "toolDescription": "Delete a differential price",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/differential_prices/{differential-price-id}/delete",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
  ...
  "paramsMap": {
    "path": {
      "differential-price-id": "differential-price-id"
    },
    "header": {
