...
const tool: OpenMCPServerTool = {
  "toolName": "update_hierarchy_access_settings_for_a_customer",
  "toolDescription": "Update account hierarchy access settings for a customer",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/customers/{customer-id}/update_hierarchy_settings",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
