...
const tool: OpenMCPServerTool = {
  "toolName": "record_an_excess_payment_for_a_customer",
  "toolDescription": "Record an excess payment for a customer",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/customers/{customer-id}/record_excess_payment",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
