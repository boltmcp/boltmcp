...
const tool: OpenMCPServerTool = {
  "toolName": "delete_an_unbilled_charge",
  "toolDescription": "Delete an unbilled charge",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/unbilled_charges/{unbilled-charge-id}/delete",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
  ...
  "paramsMap": {
    "path": {
      "unbilled-charge-id": "unbilled-charge-id"
    },
    "header": {
