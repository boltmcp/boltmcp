...
const tool: OpenMCPServerTool = {
  "toolName": "checkout_charge_items_and_one_time_charges",
  "toolDescription": "Checkout charge-items and one-time charges",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/hosted_pages/checkout_one_time_for_items",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
