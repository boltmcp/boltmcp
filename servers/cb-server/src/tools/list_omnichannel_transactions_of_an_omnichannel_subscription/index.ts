...
const tool: OpenMCPServerTool = {
  "toolName": "list_omnichannel_transactions_of_an_omnichannel_subscription",
  "toolDescription": "List Omnichannel transactions of an Omnichannel subscription",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/omnichannel_subscriptions/{omnichannel-subscription-id}/omnichannel_transactions",
  "method": "get",
  "security": [
    {
      "key": "Authorization",
  ...
  "paramsMap": {
    "path": {
      "omnichannel-subscription-id": "omnichannel-subscription-id"
    },
    "query": {
      "limit": "limit",
      "offset": "offset"
