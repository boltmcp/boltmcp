...
const tool: OpenMCPServerTool = {
  "toolName": "list_hierarchy_details",
  "toolDescription": "Get paginated account hierarchy for a customer",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/customers/{customer-id}/hierarchy_detail",
  "method": "get",
  "security": [
    {
      "key": "Authorization",
  ...
  "paramsMap": {
    ...
    "query": {
      "limit": "limit",
      "offset": "offset",
      "hierarchy_operation_type": "hierarchy_operation_type"
    },
    "header": {
