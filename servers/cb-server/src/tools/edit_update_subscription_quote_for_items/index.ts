...
const tool: OpenMCPServerTool = {
  "toolName": "edit_update_subscription_quote_for_items",
  "toolDescription": "Edit a quote for subscription update",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/quotes/{quote-id}/edit_update_subscription_quote_for_items",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
