...
const tool: OpenMCPServerTool = {
  "toolName": "create_pricing_page_for_new_subscription",
  "toolDescription": "Create pricing page for new subscription",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/pricing_page_sessions/create_for_new_subscription",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
