...
const tool: OpenMCPServerTool = {
  "toolName": "edit_create_subscription_quote_for_items",
  "toolDescription": "Edit a quote for subscription creation",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/quotes/{quote-id}/edit_create_subscription_quote_for_items",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
