...
const tool: OpenMCPServerTool = {
  "toolName": "process_purchase_command",
  "toolDescription": "Process Purchase Command",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/in_app_subscriptions/{in-app-subscription-app-id}/process_purchase_command",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
