...
const tool: OpenMCPServerTool = {
  "toolName": "delete_draft_item_price",
  "toolDescription": "Delete draft item price",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/pc2_migration_item_prices/{pc2-migration-item-price-id}/delete",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
  ...
  "paramsMap": {
    "path": {
      "pc2-migration-item-price-id": "pc2-migration-item-price-id"
    },
    "header": {
