...
const tool: OpenMCPServerTool = {
  "toolName": "retrieve_an_offer_fulfillment",
  "toolDescription": "Retrieve an Offer Fulfillment",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/offer_fulfillments/{offer-fulfillment-id}",
  "method": "get",
  "security": [
    {
      "key": "Authorization",
  ...
  "paramsMap": {
    "path": {
      "offer-fulfillment-id": "offer-fulfillment-id"
    },
    "header": {
