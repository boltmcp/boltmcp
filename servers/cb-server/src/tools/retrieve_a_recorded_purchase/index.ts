...
const tool: OpenMCPServerTool = {
  "toolName": "retrieve_a_recorded_purchase",
  "toolDescription": "Retrieve a recorded purchase",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/recorded_purchases/{recorded-purchase-id}",
  "method": "get",
  "security": [
    {
      "key": "Authorization",
  ...
  "paramsMap": {
    "path": {
      "recorded-purchase-id": "recorded-purchase-id"
    },
    "header": {
