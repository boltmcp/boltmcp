...
const tool: OpenMCPServerTool = {
  "toolName": "one_time_purchase",
  "toolDescription": "One time purchase",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/non_subscriptions/{non-subscription-app-id}/one_time_purchase",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
  ...
  "paramsMap": {
    "path": {
      "non-subscription-app-id": "non-subscription-app-id"
    },
    "header": {
