...
const tool: OpenMCPServerTool = {
  "toolName": "add_remove_or_update_options_for_the_product",
  "toolDescription": "Add remove or update options for the product",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/products/{product-id}/update_options",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
