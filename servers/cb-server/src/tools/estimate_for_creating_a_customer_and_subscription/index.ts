...
const tool: OpenMCPServerTool = {
  "toolName": "estimate_for_creating_a_customer_and_subscription",
  "toolDescription": "Estimate for creating a customer and subscription",
  "baseUrl": "https://medimitra-test.chargebee.com/api/v2/",
  "path": "/estimates/create_subscription_for_items",
  "method": "post",
  "security": [
    {
      "key": "Authorization",
